...
open class SkinnableViewSwitcher @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : ViewSwitcher(context, attrs), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableViewSwitcher[R.styleable.SkinnableViewSwitcher_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableViewSwitcher[R.styleable.SkinnableViewSwitcher_android_background]
