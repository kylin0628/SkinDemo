...
open class SkinnableHorizontalScrollView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableHorizontalScrollView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableHorizontalScrollView)
        }
    }
}
