...
open class SkinnableHorizontalScrollView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : HorizontalScrollView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableHorizontalScrollView[R.styleable.SkinnableHorizontalScrollView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableHorizontalScrollView[R.styleable.SkinnableHorizontalScrollView_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableHorizontalScrollView, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableHorizontalScrollView)
        typedArray.recycle()
    }
}
