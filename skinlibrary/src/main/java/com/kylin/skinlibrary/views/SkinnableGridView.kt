...
open class SkinnableGridView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : GridView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableGridView[R.styleable.SkinnableGridView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableGridView[R.styleable.SkinnableGridView_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableGridView, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableGridView)
        typedArray.recycle()
    }
}
