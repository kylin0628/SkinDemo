...
open class SkinnableToolbar @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : Toolbar(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableToolbar[R.styleable.SkinnableToolbar_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableToolbar[R.styleable.SkinnableToolbar_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableToolbar, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableToolbar)
        typedArray.recycle()
    }
}
