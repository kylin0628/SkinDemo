...
open class SkinnableRelativeLayout @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableRelativeLayout[R.styleable.SkinnableRelativeLayout_android_background], resId)
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableRelativeLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableRelativeLayout)
        }
    }
}
