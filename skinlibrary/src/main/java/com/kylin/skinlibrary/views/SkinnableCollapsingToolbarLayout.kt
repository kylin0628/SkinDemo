...
open class SkinnableCollapsingToolbarLayout @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableCollapsingToolbarLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableCollapsingToolbarLayout)
        }
    }
}
