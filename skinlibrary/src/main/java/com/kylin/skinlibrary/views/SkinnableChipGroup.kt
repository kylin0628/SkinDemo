...
open class SkinnableChipGroup @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ChipGroup(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableChipGroup[R.styleable.SkinnableChipGroup_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableChipGroup[R.styleable.SkinnableChipGroup_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableChipGroup, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableChipGroup)
        typedArray.recycle()
    }
}
