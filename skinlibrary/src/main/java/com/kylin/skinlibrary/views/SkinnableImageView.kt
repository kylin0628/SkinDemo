...
open class SkinnableImageView @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableImageView[R.styleable.SkinnableImageView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableImageView[R.styleable.SkinnableImageView_android_background]
        val bgResourceId = attrsBean.getViewResource(key)
        if (bgResourceId > 0) {
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableImageView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableImageView)
        }
    }
}
