...
open class SkinnableAutoCompleteTextView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.autoCompleteTextViewStyle
) : AppCompatAutoCompleteTextView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableAutoCompleteTextView[R.styleable.SkinnableAutoCompleteTextView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableAutoCompleteTextView[R.styleable.SkinnableAutoCompleteTextView_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableAutoCompleteTextView[R.styleable.SkinnableAutoCompleteTextView_android_textColor]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableAutoCompleteTextView, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableAutoCompleteTextView)
        typedArray.recycle()
    }
}
