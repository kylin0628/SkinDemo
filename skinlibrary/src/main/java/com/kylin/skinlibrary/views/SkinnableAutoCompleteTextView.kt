...
open class SkinnableAutoCompleteTextView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableAutoCompleteTextView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableAutoCompleteTextView)
        }
    }
}
