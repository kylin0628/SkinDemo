...
open class SkinnableFrameLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableFrameLayout[R.styleable.SkinnableFrameLayout_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        val key = R.styleable.SkinnableFrameLayout[R.styleable.SkinnableFrameLayout_android_background]
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableFrameLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableFrameLayout)
        }
    }
}
