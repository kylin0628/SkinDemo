...
open class SkinnableTextClock @JvmOverloads constructor(
    ...
    override fun skinnableView() {
        ...
        val textKey = R.styleable.SkinnableTextClock[R.styleable.SkinnableTextClock_android_text]
        val textSizeKey = R.styleable.SkinnableTextClock[R.styleable.SkinnableTextClock_android_textSize]
