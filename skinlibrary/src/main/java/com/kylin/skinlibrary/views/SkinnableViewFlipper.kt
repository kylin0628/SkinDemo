...
open class SkinnableViewFlipper @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : ViewFlipper(context, attrs), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableViewFlipper[R.styleable.SkinnableViewFlipper_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableViewFlipper[R.styleable.SkinnableViewFlipper_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableViewFlipper, 0, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableViewFlipper)
        typedArray.recycle()
    }
}
