...
open class SkinnableRecyclerView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : RecyclerView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableRecyclerView[R.styleable.SkinnableRecyclerView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableRecyclerView[R.styleable.SkinnableRecyclerView_android_background]
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableRecyclerView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableRecyclerView)
        }
    }
}
