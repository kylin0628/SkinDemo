...
open class SkinnableToggleButton @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.buttonStyleToggle
) : ToggleButton(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableToggleButton[R.styleable.SkinnableToggleButton_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableToggleButton[R.styleable.SkinnableToggleButton_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableToggleButton[R.styleable.SkinnableToggleButton_android_textColor]
        ...
        val textKey = R.styleable.SkinnableToggleButton[R.styleable.SkinnableToggleButton_android_text]
        val textSizeKey = R.styleable.SkinnableToggleButton[R.styleable.SkinnableToggleButton_android_textSize]
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableToggleButton, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableToggleButton)
        }
    }
}
