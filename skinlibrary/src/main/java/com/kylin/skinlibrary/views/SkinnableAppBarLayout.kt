...
open class SkinnableAppBarLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : AppBarLayout(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableAppBarLayout[R.styleable.SkinnableAppBarLayout_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableAppBarLayout[R.styleable.SkinnableAppBarLayout_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableAppBarLayout, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableAppBarLayout)
        typedArray.recycle()
    }
}
