...
open class SkinnableNestedScrollView @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableNestedScrollView[R.styleable.SkinnableNestedScrollView_android_background], resId)
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableNestedScrollView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableNestedScrollView)
        }
    }
}
