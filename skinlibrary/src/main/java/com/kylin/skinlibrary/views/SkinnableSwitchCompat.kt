...
class SkinnableSwitchCompat @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableSwitchCompat, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableSwitchCompat)
        typedArray.recycle()
    }
}
