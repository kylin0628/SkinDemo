...
open class SkinnableChip @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : Chip(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableChip[R.styleable.SkinnableChip_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableChip[R.styleable.SkinnableChip_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableChip[R.styleable.SkinnableChip_android_textColor]
        ...
        val textKey = R.styleable.SkinnableChip[R.styleable.SkinnableChip_android_text]
        val textSizeKey = R.styleable.SkinnableChip[R.styleable.SkinnableChip_android_textSize]
