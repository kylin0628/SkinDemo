...
open class SkinnableButton @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.buttonStyle
) : MaterialButton(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableButton[R.styleable.SkinnableButton_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        val textKey = R.styleable.SkinnableButton[R.styleable.SkinnableButton_android_text]
        val textSizeKey = R.styleable.SkinnableButton[R.styleable.SkinnableButton_android_textSize]
