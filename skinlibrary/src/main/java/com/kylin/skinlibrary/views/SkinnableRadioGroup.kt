...
open class SkinnableRadioGroup @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : RadioGroup(context, attrs), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableRadioGroup[R.styleable.SkinnableRadioGroup_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableRadioGroup[R.styleable.SkinnableRadioGroup_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableRadioGroup, 0, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableRadioGroup)
        typedArray.recycle()
    }
}
