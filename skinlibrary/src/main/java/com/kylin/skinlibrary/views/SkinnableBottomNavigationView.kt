...
open class SkinnableBottomNavigationView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : BottomNavigationView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableBottomNavigationView[R.styleable.SkinnableBottomNavigationView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableBottomNavigationView[R.styleable.SkinnableBottomNavigationView_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableBottomNavigationView, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableBottomNavigationView)
        typedArray.recycle()
    }
}
