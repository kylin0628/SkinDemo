...
open class SkinnableFloatingActionButton @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FloatingActionButton(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableFloatingActionButton[R.styleable.SkinnableFloatingActionButton_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableFloatingActionButton[R.styleable.SkinnableFloatingActionButton_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableFloatingActionButton, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableFloatingActionButton)
        typedArray.recycle()
    }
}
