...
open class SkinnableFloatingActionButton @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableFloatingActionButton, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableFloatingActionButton)
        }
    }
}
