...
open class SkinnableEditText @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableEditText[R.styleable.SkinnableEditText_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        val textKey = R.styleable.SkinnableEditText[R.styleable.SkinnableEditText_android_text]
        val textSizeKey = R.styleable.SkinnableEditText[R.styleable.SkinnableEditText_android_textSize]
        ...
        val hintKey = R.styleable.SkinnableEditText[R.styleable.SkinnableEditText_android_hint]
