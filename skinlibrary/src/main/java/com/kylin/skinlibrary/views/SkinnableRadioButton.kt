...
open class SkinnableRadioButton @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = android.R.attr.radioButtonStyle
) : AppCompatRadioButton(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableRadioButton[R.styleable.SkinnableRadioButton_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableRadioButton[R.styleable.SkinnableRadioButton_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableRadioButton[R.styleable.SkinnableRadioButton_android_textColor]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableRadioButton, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableRadioButton)
        typedArray.recycle()
    }
}
