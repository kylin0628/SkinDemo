...
open class SkinnableTextInputEditText @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : TextInputEditText(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableTextInputEditText[R.styleable.SkinnableTextInputEditText_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableTextInputEditText[R.styleable.SkinnableTextInputEditText_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableTextInputEditText[R.styleable.SkinnableTextInputEditText_android_textColor]
        ...
        val textKey = R.styleable.SkinnableTextInputEditText[R.styleable.SkinnableTextInputEditText_android_text]
        val textSizeKey = R.styleable.SkinnableTextInputEditText[R.styleable.SkinnableTextInputEditText_android_textSize]
