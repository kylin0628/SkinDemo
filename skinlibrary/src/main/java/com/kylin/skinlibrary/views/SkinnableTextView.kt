...
open class SkinnableTextView @JvmOverloads constructor(
    ...
    override fun skinnableView() {
        ...
        val textKey = R.styleable.SkinnableTextView[R.styleable.SkinnableTextView_android_text]
        val textSizeKey = R.styleable.SkinnableTextView[R.styleable.SkinnableTextView_android_textSize]
