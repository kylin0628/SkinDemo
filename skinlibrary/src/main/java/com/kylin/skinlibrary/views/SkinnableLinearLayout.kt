...
open class SkinnableLinearLayout @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableLinearLayout[R.styleable.SkinnableLinearLayout_android_background], resId)
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableLinearLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableLinearLayout)
        }
    }
}
