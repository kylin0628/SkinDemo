...
open class SkinnableDrawerLayout @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : DrawerLayout(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableDrawerLayout[R.styleable.SkinnableDrawerLayout_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableDrawerLayout[R.styleable.SkinnableDrawerLayout_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableDrawerLayout, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableDrawerLayout)
        typedArray.recycle()
    }
}
