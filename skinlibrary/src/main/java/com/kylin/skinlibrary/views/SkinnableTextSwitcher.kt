...
open class SkinnableTextSwitcher @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : TextSwitcher(context, attrs), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableTextSwitcher[R.styleable.SkinnableTextSwitcher_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableTextSwitcher[R.styleable.SkinnableTextSwitcher_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableTextSwitcher, 0, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableTextSwitcher)
        typedArray.recycle()
    }
}
