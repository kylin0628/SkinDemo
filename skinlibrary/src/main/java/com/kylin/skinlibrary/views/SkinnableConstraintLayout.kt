...
open class SkinnableConstraintLayout @JvmOverloads constructor(
    context: Context,
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableConstraintLayout[R.styleable.SkinnableConstraintLayout_android_background], resId)
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableConstraintLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableConstraintLayout)
        }
    }
}
