...
open class SkinnableTextInputLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : TextInputLayout(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableTextInputLayout[R.styleable.SkinnableTextInputLayout_android_background], resId)
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableTextInputLayout, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableTextInputLayout)
        typedArray.recycle()
    }
}
