...
open class SkinnableTextInputLayout @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableTextInputLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableTextInputLayout)
        }
    }
}
