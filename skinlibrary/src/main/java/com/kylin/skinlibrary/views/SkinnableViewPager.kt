...
open class SkinnableViewPager @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : ViewPager(context, attrs), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableViewPager[R.styleable.SkinnableViewPager_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableViewPager[R.styleable.SkinnableViewPager_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableViewPager, 0, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableViewPager)
        typedArray.recycle()
    }
}
