...
open class SkinnableExpandableListView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ExpandableListView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableExpandableListView[R.styleable.SkinnableExpandableListView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableExpandableListView[R.styleable.SkinnableExpandableListView_android_background]
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkinnableExpandableListView, defStyleAttr, 0)
        attrsBean.saveViewResource(typedArray, R.styleable.SkinnableExpandableListView)
        typedArray.recycle()
    }
}
