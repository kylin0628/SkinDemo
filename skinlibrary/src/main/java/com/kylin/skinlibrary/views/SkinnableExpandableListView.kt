...
open class SkinnableExpandableListView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableExpandableListView, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableExpandableListView)
        }
    }
}
