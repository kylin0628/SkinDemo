...
open class SkinnableCoordinatorLayout @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.SkinnableCoordinatorLayout, defStyleAttr, 0) {
            attrsBean.saveViewResource(this, R.styleable.SkinnableCoordinatorLayout)
        }
    }
}
