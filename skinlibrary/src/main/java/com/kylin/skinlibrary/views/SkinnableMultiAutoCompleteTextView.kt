...
open class SkinnableMultiAutoCompleteTextView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : MultiAutoCompleteTextView(context, attrs, defStyleAttr), ViewsMatch {
    ...
    override fun setBackgroundResource(resId: Int) {
        attrsBean.updateViewResource(R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_background], resId)
    ...
    override fun skinnableView() {
        ...
        // background
        var key = R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_background]
        ...
        // textColor
        key = R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_textColor]
        ...
        val textKey = R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_text]
        val textSizeKey = R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_textSize]
        ...
        val hintKey = R.styleable.SkinnableMultiAutoCompleteTextView[R.styleable.SkinnableMultiAutoCompleteTextView_android_hint]
